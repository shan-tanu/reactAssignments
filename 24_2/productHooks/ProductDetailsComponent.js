        ...
        <div className="card" style={styleObject.containerStyle}>
            ...
            <div className="card-body">
                <div>
                    ...
                    <input type="button" id={props.pid} className="btn btn-primary" value="Update" onClick={props.fetchUpdate} />
                    <input type="button" id={props.pid} className="btn btn-primary" value="Delete" onClick={props.delete} style={{marginLeft:"80px"}}/>
                </div>
            </div>
        </div>
    )
